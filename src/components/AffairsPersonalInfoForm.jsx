    ...
    <form method="POST" className="PersonalInfoContainer" noValidate>
      ...
      <div className="PersonalInfoContainer__gridForm">
        <div className="PersonalInfoForm">
          ...
          <div className="inputBox__form PersonalInfoForm__colSpan2">
            <input
              type="text"
              id="text"
              className="inputBox__form--input"
          ...
          <div className="inputBox__form PersonalInfoForm__rowColSpan2">
            <input
              type="text"
              id="address"
              className="inputBox__form--input"
        ...
        <div className="inputBox__form PersonalInfoForm__explanation">
          <input
            type="text"
            id="explanations"
            className="inputBox__form--input"
