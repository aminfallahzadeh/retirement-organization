function RetiredHokmInfoModalFormA() {
  return (
    <form method="POST" className="RetiredHokmInfoModalFormA">
      ...
      <div className="RetiredHokmInfoModalFormA__rowSpan3">
        ...
        <div className="RetiredHokmInfoModalFormA__rowSpan3--box">
          ...
          <div>
            ...
            <label htmlFor="janbazFormA" className="StaffInfoForm__box--label">
              جانباز
            </label>
          </div>
          ...
          <div>
            ...
            <label htmlFor="shahidFormA" className="StaffInfoForm__box--label">
              شهید
            </label>
          </div>
          ...
          <div>
            ...
            <label htmlFor="azadehFormA" className="StaffInfoForm__box--label">
              آزاده
            </label>
          </div>
        </div>
      ...
      <div className="inputBox RetiredHokmInfoModalFormA__colSpan2">
        <input
          ...
          required
        />
        <label htmlFor="lastMilitaryPlaceFormA" className="label label--light">
          آخرین محل خدمت
        </label>
      </div>
...
export default RetiredHokmInfoModalFormA;
